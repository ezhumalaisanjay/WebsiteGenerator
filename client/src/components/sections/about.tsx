...
export function AboutSection() {
  ...
  const { ref: skillsRef, isIntersecting: skillsVisible } =
    ...
    <section id="about" className="py-20 bg-white dark:bg-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={titleRef} className="text-center mb-16">
          <h2
            className={`text-3xl sm:text-4xl font-bold text-slate-900 dark:text-white mb-4 ${titleVisible ? "animate-fadeInUp" : "opacity-0"}`}
          >
            About Me
          </h2>
          <div
            className={`w-20 h-1 bg-primary-600 mx-auto rounded-full mb-8 ${titleVisible ? "animate-scaleIn animate-stagger-1" : "opacity-0"}`}
          ></div>
          <p
            className={`text-lg text-slate-600 dark:text-slate-400 max-w-3xl mx-auto ${titleVisible ? "animate-fadeInUp animate-stagger-2" : "opacity-0"}`}
          >
        ...
        >
          <div
            className={`${contentVisible ? "animate-fadeInLeft" : "opacity-0"}`}
          >
          ...
          <div
            className={`space-y-8 ${contentVisible ? "animate-fadeInRight" : "opacity-0"}`}
          >
            <div>
              ...
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-6">
                With strong foundation in React, Next.js, and Node.js, I
                transform complex business requirements into high-quality,
                user-friendly applications. My experience includes developing
                comprehensive HRMS and CRM platforms with features like
                real-time chat and AI integration.
              </p>
            ...
            <div ref={skillsRef}>
              <h4
                className={`text-xl font-semibold text-slate-900 dark:text-white mb-6 ${skillsVisible ? "animate-fadeInUp" : "opacity-0"}`}
              >
                Technical Skills
              </h4>
                ...
                {skills.map((skill, index) => (
                  ...
                  >
                    <CardContent className="p-0 text-center">
                      <div className="text-2xl mb-2 group-hover:animate-bounceIn">
                        {skill.icon}
                      </div>
